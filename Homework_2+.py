...
aqe= input("введите четное число: ")
me_list =list(range(0,20))
print(me_list)
answer = input("четные числа")
if answer =="четные":
    pass
else: 
    pass
aqe= input("введите не четное число:")
me_list =list(range( 0,20 ,2))
print(me_list)
answer = input("четные не четные числа: ")
